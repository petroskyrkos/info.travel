    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <h2 class="portfolio-title">France</h2>
            <div class="owl-carousel portfolio-details-carousel">
              <img src="assets/img/portfolio/france.jpg" class="img-fluid" alt="">
              <img src="assets/img/portfolio/fr2.jpg" class="img-fluid" alt="">
              <img src="assets/img/portfolio/fr3.jpg" class="img-fluid" alt="">
              <img src="assets/img/portfolio/fr4.jpg" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-4 portfolio-info">
            <ul>
              <li><strong>Name</strong>: France</li>
              <li><strong>Capital</strong>: Paris</li>
              <li><strong>Continent</strong>: Europe</li>
              <li><strong>Info</strong>: <a href="#">www.example.com</a></li>
              <li><strong>National language</strong>: French</li>	
            </ul>
