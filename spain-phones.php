...
<div class="section-title">
  ...
  <p>Phone Services in Madrid,Spain</p>
</div>
...
<section id="team" class="team ">
  ...
  <div class="col-lg-6">
    <div class="member d-flex align-items-start">
      ...
      <div class="member-info">
        <h4>State Tourism Agency:</h4>
        <span id="p1"><i class='bx bxs-phone'> (+34) 91 720 67 10 / 91 720 67 11 / 902 100 007</i></span>
        <p><i class='bx bxs-map' > C/ Gran Vía, 43. 28013 Madrid</i></p>
        <p id="p2"><i class='bx bx-mail-send'> turismo@madrid.org</i></p>
        <br>
        <button type="button" class="btn btn-warning" onclick="copyToClipboard('#p1')">Copy phone</button>
        <button type="button" class="btn btn-warning" onclick="copyToClipboard('#p2')">Copy email</button>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-6">
    <div class="member d-flex align-items-start">
    <div class="member-info">
        <h4>Plaza Mayor Tourist Information Office:</h4>
        <span id="p10"><i class='bx bxs-phone'> (+34) 91 454 44 10</i></span>
        <p><i class='bx bxs-map' > Plaza Mayor, 27</i></p>
        <p id="p9"><i class='bx bx-mail-send'>  turismo@esmadrid.com</i></p>
        <br>
        <button type="button" class="btn btn-warning" onclick="copyToClipboard('#p10')">Copy phone</button>
        <button type="button" class="btn btn-warning" onclick="copyToClipboard('#p9')">Copy email</button>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-6">
    <div class="member d-flex align-items-start">
    <div class="member-info">
        <h4>Adolfo Suárez Madrid – Barajas Airport: </h4>
        <span id="p3"><i class='bx bxs-phone'> (+34) 91 321 10 00 / 902 404 704</i></span>
        <br>
        <button type="button" class="btn btn-warning" onclick="copyToClipboard('#p3')">Copy phone</button>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-6">
    <div class="member d-flex align-items-start">
    <div class="member-info">
        <h4>Emergency services Madrid:</h4>
        <span id="p4"><i class='bx bxs-phone'> 112</i></span>
        <br>
        <button type="button" class="btn btn-warning" onclick="copyToClipboard('#p4')">Copy phone</button>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-6">
    ...
    <div class="member-info">
        <h4>Taxi service:</h4>
        <span id="p5"><i class='bx bxs-phone'> 91 371 21 31</i></span>
        <br>
        <button type="button" class="btn btn-warning" onclick="copyToClipboard('#p5')">Copy phone</button>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-6">
    <div class="member d-flex align-items-start">
    <div class="member-info">
        <h4>Spanish police:</h4>
        <span id="p6"><i class='bx bxs-phone'>091</i></span>
        <br>
        <button type="button" class="btn btn-warning" onclick="copyToClipboard('#p6')">Copy phone</button>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-6">
    <div class="member d-flex align-items-start">
    <div class="member-info">
        <h4>Citizen advice/information service:</h4>
        <span id="p7"><i class='bx bxs-phone'> 012</i></span>
        <br>
        <button type="button" class="btn btn-warning" onclick="copyToClipboard('#p7')">Copy phone</button>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-6">
    <div class="member d-flex align-items-start">
        <div class="member-info">
            <h4>Community of Madrid Fire Service:</h4>
            <span id="p8"><i class='bx bxs-phone'>080 / 085 / 092</i></span>
            <br>
            <button type="button" class="btn btn-warning" onclick="copyToClipboard('#p8')">Copy phone</button>
        </div>
    </div>
  </div>
