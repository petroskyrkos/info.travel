    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <h2 class="portfolio-title">Norway</h2>
            <div class="owl-carousel portfolio-details-carousel">
              <img src="assets/img/portfolio/norway.jpg" class="img-fluid" alt="">
              <img src="assets/img/portfolio/nw1.jpg" class="img-fluid" alt="">
              <img src="assets/img/portfolio/nw2.jpg" class="img-fluid" alt="">
              <img src="assets/img/portfolio/nw4.jpg" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-4 portfolio-info">
            <ul>
              <li><strong>Name</strong>: Norway</li>
              <li><strong>Capital</strong>: Oslo</li>
              <li><strong>Continent</strong>: Europe</li>
              <li><strong>Info</strong>: <a href="#">www.example.com</a></li>
              <li><strong>National language</strong>: Norwegian</li>	
            </ul>
