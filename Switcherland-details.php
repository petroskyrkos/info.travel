...
<head>
  ...
  <title>info.travel-Destinations</title>
    ...
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <h2 class="portfolio-title">Switzerland</h2>
            <div class="owl-carousel portfolio-details-carousel">
              <img src="assets/img/portfolio/swit.jpg" class="img-fluid" alt="">
              <img src="assets/img/portfolio/sw3.jpg" class="img-fluid" alt="">
              <img src="assets/img/portfolio/sw2.jpg" class="img-fluid" alt="">
              <img src="assets/img/portfolio/sw4.jpg" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-4 portfolio-info">
            <ul>
              <li><strong>Name</strong>: Switzerland</li>
              <li><strong>Capital</strong>:  Bern</li>
              <li><strong>Continent</strong>: Europe</li>
              <li><strong>Info</strong>: <a href="#">www.example.com</a></li>
              <li><strong>Language</strong>: German, French, Italian, Romansch</li>	
            </ul>
