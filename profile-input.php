        ...
        <?php
            ...
            <div class="profile-input-field" >
                    ...
                    <form method="post" action="#" >
                      ...
                      <div class="form-group">
                        <label>Gender</label>
                        <select name="gender" class="form-control" style="width:20em;" required value="<?php echo $row['gender']; ?>" >
                      ...
                      <div class="form-group">
                        <input type="submit" name="submit" value="Submit" class="w3-button w3-theme" style="width:20em; margin:0;"><br><br>
                      </div>
                    </form>
                  </div>
